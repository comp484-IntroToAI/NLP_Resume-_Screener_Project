...
resume = docx2txt.process('/content/Ke_M_Resume.docx')
...
resume_embedding = BERT_encode(resume, tokenizer, encoder)
...
print(F.cosine_similarity(resume_embedding, job_ad_embedding))